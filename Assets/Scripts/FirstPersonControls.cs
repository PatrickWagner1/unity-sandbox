...
public class FirstPersonControls : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Stop physics in x and z direction for the camera's body so  there isnt
        // any unwanted movement except for gravity
        physicalParentBody.constraints = RigidbodyConstraints.FreezePositionX
    ...
    void MouseController()
    {
        ...
        if (Input.GetKey(KeyCode.LeftControl) || useGravity)
        {
            ...
            // This is used so the camera doesnt start to tilt and stays in some form parallel
            // to the ground like in common fps games.
            ...
            // alternative rotation. not so direct but smoother.
            //Quaternion.Lerp(transform.rotation, targetRot, Time.deltaTime);
        }
    }
    ...
    void KeyboardController()
    {
        ...
        if (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.D))
            physicalParent.transform.localPosition += transform.right * Time.deltaTime
                * movementSpeed;
        ...
        if (Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.W))
            physicalParent.transform.localPosition += transform.forward * Time.deltaTime
                * movementSpeed;
        ...
        if (Input.GetKey(KeyCode.Space))
            physicalParent.transform.localPosition += new Vector3(0, 1, 0) * Time.deltaTime
                * movementSpeed;
